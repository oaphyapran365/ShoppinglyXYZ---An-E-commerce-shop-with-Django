...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    {'autocomlete': 'current-password', 'autofocus':True, 'class':'form-control'}))

    new_password1 = forms.CharField(label=_("New Password"), strip= False, widget=forms.PasswordInput(attrs=
    {'autocomlete': 'new-password',  'class':'form-control'}), 
...
class MyPasswordResetForm(PasswordResetForm):
    ...
    {'autocomlete': 'email',  'class':'form-control'}))



class MySetPasswordeForm(SetPasswordForm):
